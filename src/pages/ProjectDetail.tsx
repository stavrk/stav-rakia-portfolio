          ...
          <div className="max-w-4xl mx-auto">
            ...
            {project.slug === 'plant-module' && project.wireflow && (
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">The wireflow outlines the app's structure and user journey, focusing on personalized content and intuitive branching paths.</p>
