...
const ProjectDetail = () => {
  ...
  const [openInteractions, setOpenInteractions] = useState<string[]>([]);
  ...
  const interactiveElements = [
    {
      ...
      description: "Match plants to ideal light conditions with intuitive drag interfaces",
      icon: Move
    },
    {
      id: "quizzes",
      title: "Interactive quizzes",
      description: "Test your knowledge about watering requirements through engaging questions",
      icon: FileQuestion
    },
    {
      id: "simulations",
      title: "Visual simulations",
      description: "See how plants respond to different care conditions through dynamic visualizations",
      icon: Lightbulb
    },
    {
      id: "progress",
      title: "Progress tracking",
      description: "Monitor your advancement and stay motivated throughout the learning journey",
      icon: BarChart
    }
  ];
  ...
  const wireflowSteps = [
    {
      ...
      description: "Highlights the value and benefits of houseplants in your living space"
    },
    {
      icon: Folders,
      title: "Category navigation",
      description: "Explore different plant types based on your interests and home environment"
    },
    {
      icon: CircleCheck,
      title: "Interactive checkpoints",
      description: "Assess your understanding through engaging activities and questions"
    },
    {
      icon: ArrowDownRight,
      title: "Practical application",
      description: "Apply your knowledge in real-life scenarios to build confidence"
    }
  ];
