...
const projectsData = [{
  ...
  slug: "roomie",
  color: "#DC665C", // Updated color from #F4DB8B to #DC665C
  ...
  designImages: [{
    ...
    description: "Warm, calming tones with soft reds and muted accents" // Updated description
  }, {
    title: "Typography",
