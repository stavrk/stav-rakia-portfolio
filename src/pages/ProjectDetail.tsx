          ...
          <div className="max-w-4xl mx-auto">
            ...
            {project.wireflow && (
              ...
              >
                ...
                <div className="prose prose-lg max-w-none mb-8">
                  <p className="mb-4 text-muted-foreground">{project.wireflow.description}</p>
                </div>
                ...
                <div className="prose prose-lg max-w-none">
                  {project.interactiveElements.description.split('\n').map((line, idx) => (
                    line.startsWith('- ') ? (
                      ...
                      <p key={idx} className="mb-4 text-muted-foreground">{line}</p>
                    )
                  ))}
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {project.designImages && project.designImages.map((image, idx) => (
                  <motion.div 
                    key={idx} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {project.additionalImages.map((image, idx) => (
                    <motion.div 
                      ...
                      transition={{ delay: idx * 0.1, duration: 0.5 }}
                    >
                      <img src={image} alt={`Additional view ${idx + 1}`} className="w-full h-auto" />
                    </motion.div>
                  ))}
                </div>
              </motion.div>
            ...
            {project.link && (
              <motion.div 
                ...
                transition={{ duration: 0.5 }}
              >
                <ProjectLink href={project.link}>View Full Project</ProjectLink>
              </motion.div>
            )}
            ...
            >
              ...
              >
                <div>
                  <h3 className="text-xl md:text-2xl font-medium group-hover:text-primary transition-colors">{nextProject.title}</h3>
                  <p className="text-muted-foreground">{nextProject.description.substring(0, 60)}...</p>
                </div>
                <div className="ml-4 p-3 rounded-full bg-secondary text-secondary-foreground group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
