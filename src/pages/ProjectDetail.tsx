      ...
      <section className="py-20">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Enhanced Wireflow Section - For Plant Learning Module project */}
              ...
              >
                ...
                <div className="bg-secondary/30 p-6 rounded-xl mb-8 border border-border/30">
                  <p className="text-muted-foreground mb-6">
                    The wireflow illustrates the app's structure and user journey, emphasizing personalized content and intuitive navigation paths.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-4">Key flows include:</h3>
